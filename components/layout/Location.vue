  ...
  >
    <div class="relative pb-52 s:pb-20 m:pb-0">
      <div class="bg-grey-100 s:max-w-[50%] shadow-illustration p-0 m:p-8">
        <HeadingSection level="2" class="text-xl"> Transports </HeadingSection>
        <Heading level="3"> Comment rejoindre<br>l'évènement ? </Heading>
        ...
        <div>
          <span class="font-bold text-2xl">Transport en commun : </span>
          <span>Bus 15 ou Tram C</span>
        </div>
        <div>
          <span class="font-bold text-2xl">Vélo : </span>
          <span> Parking vélo disponible et station VCub à proximité </span>
        </div>
        <div>
