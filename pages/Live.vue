...
<template>
  <main>
    <section class="p-section">
      <Heading level="1" class="!relative !z-10 title w-fit mx-auto"> Le live </Heading>
      <ul v-if="data.length" class="flex flex-wrap gap-10 justify-center my-8">
      ...
      <p v-else>Pas de live pour le moment !</p>
    </section>
  </main>
</template>
