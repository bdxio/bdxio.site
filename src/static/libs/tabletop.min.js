      ...
      return this && this instanceof h
        ? ("string" == typeof t && (t = { key: t }),
          ...
          (this.prettyColumnNames =
            "undefined" == typeof t.prettyColumnNames ? !t.proxy : t.prettyColumnNames),
          ...
          this.key
            ? (this.log("Initializing with key " + this.key),
              ...
              e || s ? (this.baseJsonPath += "json") : (this.baseJsonPath += "json-in-script"),
    ...
    (h.prototype = {
      ...
      injectScript: function(e, t) {
        ...
        this.simpleUrl
          ...
          this.parameterize && (i.src = this.parameterize + encodeURIComponent(i.src)),
        ...
        for (
          ...
          if (
            ...
            (l += e || s ? "json" : "json-in-script"),
              ...
              this.orderby && (l += "&orderby=column:" + this.orderby.toLowerCase()),
