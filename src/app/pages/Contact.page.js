              ...
              <div className="row contact-container-content">
                ...
                >
                  <div>
                    ...
                    <h5 className="contact-container-content-partner-title">
                      ...
                      <span className="textGradient">sponsor</span> ou vous avez des questions
                      concernant les <span className="textGradient">partenariats</span> c'est ici :
                    </h5>
                  </div>
                ...
                >
                  <div>
                    ...
                    <h5 className="contact-container-content-partner-title">
                      Vous êtes <span className="textGradient">speaker</span> ou vous cherchez à le
                      devenir, attendez <span className="textGradient">l'ouverture du CFP </span>
                      début juin <br />
                      ou contacter nous ici :
                    </h5>
                  </div>
                  <span className="contact-container-content-speaker-address align-middle arrowElement">
                    <a href="mailto://team@bdx.io" target="_blank" className="button small primary">
                      team@bdx.io
                    </a>
                  </span>
                </div>
                ...
                >
                  <div>
                    ...
                    <h5 className="contact-container-content-news-title">
                      ...
                      <span className="textGradient"> BDX I/O</span> vous avez le choix ici :
                    </h5>
                  </div>
                  <div className="contact-container-content-news-address arrowElement align-middle">
                    ...
                    <div className="contact-container-content-news-address-mail">
                      <span className="arrowElement">
                        <a className="button small primary" onClick={this.focusSubscription}>
