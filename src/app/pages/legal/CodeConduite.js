                ...
                <div className="row code-conduite-container align-center">
                    ...
                    <div className="column small-12 large-8">
                        <p className="code-conduite-content text-justify">
                            <b>Toutes les personnes qui participent à la conférence doivent accepter le code de conduite
                            suivant.</b> L'équipe d'organisation s'attachera à faire respecter ce code durant l'événement.
                        ...
                        <h4>Besoin d'aide ?</h4>
                        <ul>
                            <li className="code-conduite-content-mail">par email : <a href="mailto://team@bdx.io" target="_blank">team@bdx.io</a></li>
                            <li className="code-conduite-content-twitter">par twitter : <a href="https://twitter.com/bdxio" target="_blank">@bdxio</a></li>
                        </ul>
                        <p className="code-conduite-content text-justify">
                            <b>Notre conférence se veut une expérience sans harcèlement</b>, quelque soit votre sexe,
                        ...
                        <p className="code-conduite-content text-justify">
                            <b>Le harcèlement</b> inclut des commentaires oraux sur le sexe, l'orientation sexuelle,
                        ...
                        <p className="code-conduite-content text-justify">
                            Les personnes à qui il sera demandé d'arrêter  <b>tout comportement de harcèlement</b> doivent arrêter immédiatement.
                        </p>
                        <p className="code-conduite-content text-justify">
                        ...
                        <p className="code-conduite-content text-justify">
                            <b>Si un participant ou une participante a un comportement de harcèlement</b>, l'équipe d'organisation de la
                        ...
                        <p className="code-conduite-content text-justify">
                            <b>Si vous vous sentez victime de harcèlement</b>, si vous pensez que quelqu'un se fait harceler,
                        ...
                        <p className="code-conduite-content text-justify">
                            Nous attendons des personnes présentes à l'événement qu'elles <b>suivent ces règles</b> dans le bâtiment des
                            conférences et des ateliers, ainsi que pendant les événements sociaux relatifs à la conférence.
                        </p>
                        <p className="code-conduite-content text-justify">
                            <b>Version originale et crédit :</b> <a href="http://2012.jsconf.us/#/about">http://2012.jsconf.us/#/about</a> & The Ada Initiative<br />
                            <b>Merci d'aider à la traduction et à l'amélioration de ce texte :</b> <a href="http://github.com/leftlogic/confcodeofconduct.com">http://github.com/leftlogic/confcodeofconduct.com</a><br />
                            <b>Ce texte est sous licence</b> <a href="http://creativecommons.org/licenses/by/3.0/deed.en_US">Creative Commons Attribution 3.0 Unported License</a>
                        </p>
                    </div>
                </div>
                {this.props.children}
