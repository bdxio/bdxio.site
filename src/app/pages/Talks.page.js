                ...
                <div className="row align-center talks-container">
                    ...
                    <div className="column text-center">
                        ...
                        <div className="row align-center">
                            <div className="columns shrink talks-container-content-item-talk-type-small-tag ">Tag-1
                            </div>
                            <div className="columns shrink talks-container-content-item-talk-type-small-tag ">Tag-1
                            </div>
                            <div className="columns shrink talks-container-content-item-talk-type-small-tag ">Tag-1
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        ...
                                                        <div className="columns">
                                                            ...
                                                            <div
                                                                className="row talks-container-content-item-talk-type align-center">
                                                                <div
                                                                    className="columns text-center shrink talks-container-content-item-talk-type-tag shrink">
                                                                    {talk.talkType}
                                                                </div>
                                                            </div>
                                                            <div
                                                            ...
                                                            <hr/>
                                                            <div className="talks-container-content-item-text-speaker">
                                                                Nom speaker
                                                                {/*TODO speaker name */}
                                                            </div>
                                                        </div>
                                    ...
                                    <div className="column">
                                        ...
                                        >
                                            <div className="columns text-center auto talk-container-content-item-text talk-container-content-item-large-text">
                                                <div className="row">
                                                    <h5 className="columns">
                                                        {selectedTalk.title}
                                                    </h5>
                                                </div>
                                                <div className="row talks-container-content-item-talk-type align-center">
                                                    <div
                                                        className="columns text-center shrink talks-container-content-item-talk-type-tag">
