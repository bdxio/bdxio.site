          ...
          <div className="column small-11 large-6 ticket-switch__wrapper">
            ...
            <div className="row align-justify align-middle ticket-switch__spacer collapse">
              ...
              <input
                ...
                onChange={this.handleChange("holderFirstname")}
              />
            </div>
            <div className="row align-justify align-middle ticket-switch__spacer collapse">
              ...
              <input
                className="column auto ticket-switch__field required"
                value={holderLastanme}
                onChange={this.handleChange("holderLastanme")}
              />
            </div>
            <div className="row align-justify align-middle ticket-switch__spacer collapse">
              <label className="column small-4 ticket-switch__label">
              ...
              <input
                ...
                onChange={this.handleChange("holderEmail")}
              />
            </div>
            <div className="row align-justify align-middle ticket-switch__spacer collapse">
              <label className="column small-4 ticket-switch__label">
              ...
              <input
                className="column auto ticket-switch__field required"
                value={commandNumber}
                onChange={this.handleChange("commandNumber")}
              />
            </div>
            ...
            <div className="row align-justify align-middle ticket-switch__spacer collapse">
              ...
              <input
                ...
                onChange={this.handleChange("recipientFirstname")}
              />
            </div>
            <div className="row align-justify align-middle ticket-switch__spacer collapse">
              <label className="column small-4 ticket-switch__label">Nom</label>
            ...
            <div className="ticket-switch__button-wrapper">
              <button
                className="ticket-switch__button button medium primary"
