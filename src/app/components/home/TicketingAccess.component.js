        ...
        return (
            <section className="row ticketingAccess">
                ...
                <div className="row align-center">
                    <div className="columns small-10 text-center">
                        <div className="row align-center ticketingAccess-container">
                            <div className="ticketingAccess-container-item">
                                <div className="row align-center ticketingAccess-container-item-infos">
                                    <div className="columns ticketingAccess-container-item-infos-title">
                                        ...
                                        <div className="columns ticketingAccess-container-item-infos-title-classe">Early
                                            Bird
                                        </div>
                                    </div>
                                ...
                                <div
                                    className={'row ticketingAccess-container-item-content ' + (!registrationIsOpened ? 'disabled' : '')}>
                            ...
                            <div className="ticketingAccess-container-item">
                                <div className="row align-center ticketingAccess-container-item-infos">
                                    <div className="columns ticketingAccess-container-item-infos-title">
                                        ...
                                        <div
                                            className="columns ticketingAccess-container-item-infos-title-classe">Golden
                                            Ticket
                                        </div>
                                    </div>
                                    <div className="columns ticketingAccess-container-item-infos-status">
                            ...
                            <div className="ticketingAccess-container-item">
                                <div className="row align-center ticketingAccess-container-item-infos">
                                    <div className="columns ticketingAccess-container-item-infos-title">
                                        <div className="ticketingAccess-container-item-infos-title-euros">64,00 €</div>
                                        <div
                                            className="columns ticketingAccess-container-item-infos-title-classe">Classic
                                        </div>
                                    </div>
                                    <div className="columns ticketingAccess-container-item-infos-status">
                                        Individuel
